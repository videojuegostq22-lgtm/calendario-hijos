    ...
    return (
        <div className="flex flex-col lg:flex-row h-full gap-6 overflow-hidden max-h-full">
            ...
            <div className="flex-1 flex flex-col bg-white dark:bg-zinc-900 rounded-[2rem] p-6 shadow-sm border border-gray-100 dark:border-zinc-800 overflow-hidden">
                ...
                {/* Days Grid */}
                <div className="flex-1 grid grid-cols-7 gap-2 overflow-y-auto pr-1 pb-12">
                    {calendarDays.map((day) => {
                        ...
                        return (
                            <button
                                ...
                                className={cn(
                                    "relative rounded-xl md:rounded-2xl p-1 transition-all flex flex-col items-center justify-start pt-2 gap-1 min-h-[6.5rem] md:min-h-[7rem]",
